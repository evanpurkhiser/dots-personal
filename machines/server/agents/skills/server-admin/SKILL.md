---
name: server-admin
description: Server administration knowledge for Evan's personal home server, including Home Assistant operations, services, configs, network layout, and operational procedures.
---
...
- **Operations**: Home Assistant operations can likely be performed through the
  enabled `home-assistant` MCP server. Check its tools before editing config files.
